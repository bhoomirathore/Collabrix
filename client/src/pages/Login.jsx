  ...
  return (
    <div className="min-h-screen bg-[#090b11] text-[#e2e8f0] flex items-center justify-center p-6 relative font-mono select-none overflow-hidden">
      ...
      <form
        ...
        className="w-full max-w-md bg-[#0f131a] border border-[#1e293b] p-8 rounded-2xl shadow-2xl relative z-10 space-y-6 animate-fade-in"
      >
        <div className="space-y-2 text-center">
          <div className="text-[10px] uppercase tracking-widest text-indigo-400 font-bold">OPERATIONAL GATEWAY</div>
          <h1 className="text-2xl font-bold tracking-tight text-[#f8fafc]">COLLABRIX AUTH</h1>
        </div>
        ...
        <div className="text-center pt-2">
          ...
          >
            Create Developer space Instead ↗
          </Link>
        </div>
      </form>
    </div>
